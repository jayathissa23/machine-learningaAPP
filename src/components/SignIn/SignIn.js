...
return (
<div>
{/* <div style={{transform:"scale(1.45, 1.45)"}}> */}
<article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw7 shadow-1 center"  >    
...
<form className="measure ">
        ...
        <input type="submit" value="Sign In" 
            className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib"
             ...
             /><br />
         <br/>
        <label className="db fw6 lh-copy f6 pointer"
        onClick={()=>onRouteChange('register')}>Registar</label>
</form>
    </main>
    </article>
</div>
